...
@router.post("/agriculteurs", response_model=schemas.AgriculteurResponse, status_code=status.HTTP_201_CREATED)
def creer_agriculteur(agriculteur: schemas.AgriculteurCreate, db: Session = Depends(get_db)):
