...
@router.post("/entrepots", response_model=schemas.EntrepotResponse, status_code=status.HTTP_201_CREATED)
def creer_entrepot(entrepot: schemas.EntrepotCreate, db: Session = Depends(get_db)):
